...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Event::factory()->create(['name' => 'Mysql Insight', 'speaker'=>'Maria DB', 'date_and_time'=>'2021-06-21 20:30:00', 'max_participants'=> 1, 'description'=>'Join to our first laravel workshop at Tech Events!', 'image'=>'https://images.pexels.com/photos/2643596/pexels-photo-2643596.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500', 'location'=>'Hell', 'created_at'=>'2022-04-01 08:23:29', 'updated_at'=>'2022-04-01 08:23:29']);
        Event::factory()->create(['name' => 'Learning Git', 'speaker'=>'Sandra Lee', 'date_and_time'=>'2020-03-15 18:15:00', 'max_participants'=> 0, 'description'=>'Join to our first laravel workshop at Tech Events!', 'image'=>'https://images.pexels.com/photos/3002547/pexels-photo-3002547.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500', 'location'=>'Unsplash', 'created_at'=>'2022-04-01 08:23:29', 'updated_at'=>'2022-04-01 08:23:29']);
        Event::factory()->create(['name' => 'Rigging', 'speaker'=>'Alejandro V.', 'date_and_time'=>'2022-04-27 16:30:00', 'max_participants'=> 20, 'description'=>'Join to our first laravel workshop at Tech Events!', 'image'=>'https://images.pexels.com/photos/247819/pexels-photo-247819.jpeg?cs=srgb&dl=pexels-pixabay-247819.jpg&fm=jpg', 'location'=>'Holanda', 'created_at'=>'2022-04-01 08:23:29', 'updated_at'=>'2022-04-01 08:23:29']);
